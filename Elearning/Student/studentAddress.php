...
$sql_2 = "SELECT * FROM student WHERE stu_email='$stuEmail'";
...
<div class="col-sm-6 mt-5">
    <form class="mx-5" method="POST" enctype="multipart/form-data">
        ...
        <a href="#" class="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#stuAddAdress"> Thêm </a> <!-- Qua footer -->
                 ...
                 $email = $row['stu_email'];
                    echo '
                        ...
                        <div class="form-group">
                                    ...
                                    <a href="./updateAddressFinal.php?dc_id='.$dc_id.'" class="btn btn-primary" > Chỉnh sửa địa chỉ </a>
